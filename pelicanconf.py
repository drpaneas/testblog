...
SITENAME = u"""<span style="color:black;">Linux</span> <span style="color:darkblue;">=</span> <span style="color:#AA1032;">'ed'</span>"""
SITEURL = ''
...
# Required for:
 ...
 # assets:  pip install webassets
 # tipue: pip install beautifulsoup4
